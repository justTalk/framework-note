...
public final class CacheDataSource implements DataSource {
  ...
  public interface EventListener {
     ...
     */
    void onCachedBytesRead(long cacheSizeBytes, long cachedBytesRead, boolean isReadCache, String url);
  ...
  private void notifyBytesRead() {
    if (eventListener != null && totalCachedBytesRead > 0) {
      eventListener.onCachedBytesRead(cache.getCacheSpace(), totalCachedBytesRead, isReadingFromCache(), key);
