 ...
 * the {@link Builder}.
 //*/
public final class TestBandwidthMeter implements BandwidthMeter, TransferListener {
  ...
  public static final class Builder {
     ...
     */
    public TestBandwidthMeter build() {
      ...
      TestBandwidthMeter bandwidthMeter =
          new TestBandwidthMeter(initialBitrateEstimate, slidingWindowMaxWeight, clock);
  ...
  public TestBandwidthMeter() {
    this(DEFAULT_INITIAL_BITRATE_ESTIMATE, DEFAULT_SLIDING_WINDOW_MAX_WEIGHT, Clock.DEFAULT);
  }

  /** @deprecated Use {@link Builder} instead. */
  @Deprecated
  public TestBandwidthMeter(Handler eventHandler, EventListener eventListener) {
    this(DEFAULT_INITIAL_BITRATE_ESTIMATE, DEFAULT_SLIDING_WINDOW_MAX_WEIGHT, Clock.DEFAULT);
    if (eventHandler != null && eventListener != null) {
  ...
  /** @deprecated Use {@link Builder} instead. */
  @Deprecated
  public TestBandwidthMeter(Handler eventHandler, EventListener eventListener, int maxWeight) {
  ...
  private TestBandwidthMeter(long initialBitrateEstimate, int maxWeight, Clock clock) {
    this.eventDispatcher = new EventDispatcher<>();
    this.slidingPercentile = new SlidingPercentile(maxWeight);
    this.clock = clock;
    bitrateEstimate = initialBitrateEstimate;
    Log.d("LMM", "DefaultBandwidthMeter: ");
  }
  ...
  public synchronized void onBytesTransferred(
    ...
    //Log.d("LMM", "onBytesTransferred: " + sampleBytesTransferred);
  }
